...
func _setup():
	...
	# ===== 避火庄（城镇安全区：火焰山与方寸山之间的山间客庄）=====
	# 注意：城镇须在 x>700——房间挂洲原点，内容带 0..~700
	WC.create_town(self, 1700, 130, "避火庄", [
		{"name": "庄主", "color": Color(0.6, 0.4, 0.3), "dx": -70, "lines": [
			"火焰山八百里，无芭蕉扇难行。",
			"地心火窟藏离火珠，可御火伤。",
			"庄后岩浆池，切莫误踏。",
		]},
		{"name": "避火客栈", "color": Color(0.45, 0.5, 0.4), "dx": 0, "heal": true},
		{"name": "远游香客", "color": Color(0.55, 0.5, 0.62), "dx": 70, "lines": [
			"灵台方寸山，斜月三星洞。",
			"流沙河弱水，飞行亦要小心。",
		]},
	])
